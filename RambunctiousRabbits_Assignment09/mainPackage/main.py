...
from DatabasePackage.database_query import *

if __name__ == "__main__":
    dbm = DatabaseManagement()
    conn = dbm.connect_to_Grocery_Store()
    product_query = dbm.submit_query(conn, 'SELECT ProductID, [UPC-A ], Description, ManufacturerID, BrandID FROM tProduct')
